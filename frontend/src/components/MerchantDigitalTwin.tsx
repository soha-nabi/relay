    ...
    <section className="dashboard-card">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-muted mt-2">A concise, explorable model of revenue health and recovery potential.</p>
        </div>

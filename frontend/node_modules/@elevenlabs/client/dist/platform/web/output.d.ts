...
import type { OutputController, OutputDeviceConfig, OutputConfig, PlaybackEventTarget, PlaybackListener } from "../../OutputController.js";
export type MediaDeviceOutputConfig = FormatConfig & OutputConfig & AudioWorkletConfig & {
...
export declare class MediaDeviceOutput implements OutputController, PlaybackEventTarget {
    ...
    static create({ sampleRate, format, outputDeviceId, workletPaths, libsampleratePath, audioContext, }: MediaDeviceOutputConfig): Promise<MediaDeviceOutput>;
    private volume;
    private interrupted;
